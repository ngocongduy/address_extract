...
def make_cities_data():
    ...
    for pk in p_dict.keys():
        ...
        province_node['start_index'] = ip[pk][0]
        province_node['end_index'] = ip[pk][-1]
    ...
    for dk in d_dict.keys():
        ...
        district_node['start_index'] = id[dk][0]
        district_node['end_index'] = id[dk][-1]
    ...
    for wk in w_dict.keys():
        ...
        ward_node['start_index'] = iw[wk][0]
        ward_node['end_index'] = iw[wk][-1]
...
def make_cities_data_normalized():
    ...
    for e in combinations:
        ...
        e['normalized_ward'] = ward + str(e.get('ward_code'))
        e['normalized_district'] = district+ str(e.get('district_code'))
        e['normalized_province'] = province+ str(e.get('province_code'))
